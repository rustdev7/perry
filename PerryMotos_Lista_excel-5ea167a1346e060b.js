...
function wasm_bindgen__convert__closures________invoke__h7cf5308109a2a421(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures________invoke__h7cf5308109a2a421(arg0, arg1, arg2);
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_name_f87539a54ee219b3 = function(arg0, arg1) {
        const ret = arg1.name;
        const ptr1 = passStringToWasm0(ret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        getDataViewMemory0().setInt32(arg0 + 4 * 1, len1, true);
    ...
    imports.wbg.__wbindgen_cast_13f4de67d5ea279f = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 403, function: Function { arguments: [Ref(NamedExternref("Event"))], shim_idx: 404, ret: Unit, inner_ret: Some(Unit) }, mutable: false }) -> Externref`.
        const ret = makeClosure(arg0, arg1, wasm.wasm_bindgen__closure__destroy__h0325b4e49c90a1cc, wasm_bindgen__convert__closures________invoke__h7cf5308109a2a421);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('PerryMotos_Lista_excel_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
